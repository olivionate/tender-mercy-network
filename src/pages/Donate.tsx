    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                Every dollar you give creates lasting change in the lives of widows and orphans across East Africa.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <Card className="shadow-elegant hover:shadow-glow transition-shadow">
                <CardContent className="pt-6 text-center">
                  ...
                  <h3 className="font-bold text-xl text-foreground mb-2">Education</h3>
                  <p className="text-muted-foreground mb-4">
                    $30/month sponsors one child's complete education including school fees, uniforms, and supplies.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="shadow-elegant hover:shadow-glow transition-shadow">
                <CardContent className="pt-6 text-center">
                  ...
                  <p className="text-muted-foreground mb-4">
                    $50/month provides vocational training and microfinance for widows to start businesses.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="shadow-elegant hover:shadow-glow transition-shadow">
                <CardContent className="pt-6 text-center">
                  ...
                  <h3 className="font-bold text-xl text-foreground mb-2">Emergency Relief</h3>
                  <p className="text-muted-foreground mb-4">
                    $100 provides urgent food, shelter, and medical care for a family in crisis.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="shadow-elegant hover:shadow-glow transition-shadow">
                <CardContent className="pt-6 text-center">
                  ...
                  <h3 className="font-bold text-xl text-foreground mb-2">Community</h3>
                  <p className="text-muted-foreground mb-4">
                    $250 funds community development projects including wells, schools, and churches.
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                <PieChart className="w-16 h-16 mx-auto mb-6 text-primary" />
                <h2 className="text-3xl md:text-5xl font-bold text-foreground mb-6">
                  Financial Transparency
                </h2>
                <p className="text-lg text-muted-foreground">
                  We believe in complete transparency. Here's exactly how your donation is used.
                </p>
              </div>
                  ...
                  <div className="space-y-6">
                    <div>
                      <div className="flex justify-between items-center mb-2">
                        <span className="font-semibold text-foreground">Program Services</span>
                        <span className="text-2xl font-bold text-primary">85%</span>
                      </div>
                      <div className="w-full bg-muted rounded-full h-4">
                        <div className="bg-gradient-primary h-4 rounded-full" style={{ width: '85%' }}></div>
                      </div>
                      <p className="text-sm text-muted-foreground mt-2">
                        Directly funds education, empowerment, emergency relief, and spiritual care programs.
                      </p>
                    </div>

                    <div>
                      <div className="flex justify-between items-center mb-2">
                        <span className="font-semibold text-foreground">Administrative Costs</span>
                        <span className="text-2xl font-bold text-primary">10%</span>
                      </div>
                      <div className="w-full bg-muted rounded-full h-4">
                        <div className="bg-gradient-primary h-4 rounded-full" style={{ width: '10%' }}></div>
                      </div>
                      <p className="text-sm text-muted-foreground mt-2">
                        Essential operations including staff, technology, and facilities management.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="w-full bg-muted rounded-full h-4">
                        <div className="bg-gradient-primary h-4 rounded-full" style={{ width: '5%' }}></div>
                      </div>
                      <p className="text-sm text-muted-foreground mt-2">
                        Communications, donor relations, and awareness campaigns to expand our reach.
                      </p>
                    </div>
                  </div>
                </CardContent>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <Card className="shadow-elegant text-center">
                  <CardContent className="pt-6">
                    ...
                    <h3 className="font-bold text-lg text-foreground mb-2">Certified Nonprofit</h3>
                    <p className="text-sm text-muted-foreground">
                      Registered 501(c)(3) organization with full tax-exempt status.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="shadow-elegant text-center">
                  <CardContent className="pt-6">
                    ...
                    <h3 className="font-bold text-lg text-foreground mb-2">Annual Reports</h3>
                    <p className="text-sm text-muted-foreground">
                      Complete financial audits and impact reports available publicly.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="shadow-elegant text-center">
                  <CardContent className="pt-6">
                    ...
                    <h3 className="font-bold text-lg text-foreground mb-2">Accountability</h3>
                    <p className="text-sm text-muted-foreground">
                      Independent board oversight and third-party financial audits.
                    </p>
                  </CardContent>
                </Card>
              </div>
        ...
        <section className="py-20 bg-gradient-subtle">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              <DollarSign className="w-16 h-16 mx-auto mb-6 text-primary" />
              <h2 className="text-3xl md:text-5xl font-bold text-foreground mb-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
              <Card className="shadow-elegant">
                <CardContent className="pt-6">
                  ...
                  <h3 className="font-bold text-lg text-foreground mb-2">Credit/Debit Card</h3>
                  <p className="text-sm text-muted-foreground">
                    Secure online payments with instant processing and receipts.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="shadow-elegant">
                <CardContent className="pt-6">
                  ...
                  <h3 className="font-bold text-lg text-foreground mb-2">Bank Transfer</h3>
                  <p className="text-sm text-muted-foreground">
                    Direct bank-to-bank transfers for larger one-time or recurring gifts.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="shadow-elegant">
                <CardContent className="pt-6">
                  ...
                  <h3 className="font-bold text-lg text-foreground mb-2">Mobile Money</h3>
                  <p className="text-sm text-muted-foreground">
                    M-Pesa and Airtel Money for convenient mobile donations from East Africa.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="shadow-elegant">
                <CardContent className="pt-6">
                  ...
                  <h3 className="font-bold text-lg text-foreground mb-2">International Transfer</h3>
                  <p className="text-sm text-muted-foreground">
                    PayPal and World Remit accepted for global supporters.
                  </p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="mt-12 text-center">
              <Card className="max-w-2xl mx-auto shadow-elegant bg-gradient-primary text-primary-foreground">
                <CardContent className="pt-6">
                  ...
                  <h3 className="text-2xl font-bold mb-4">Monthly Giving - Maximum Impact</h3>
                  <p className="mb-6 opacity-90">
                    Monthly donors provide sustainable support that allows us to plan long-term programs 
                    and create lasting change. Join our Circle of Compassion with a recurring gift.
                  </p>
                  <div className="flex flex-wrap justify-center gap-4">
                    <div className="bg-primary-foreground/10 backdrop-blur-sm rounded-lg p-4">
                      <div className="text-3xl font-bold">200</div>
                      <div className="text-sm opacity-90">Widows Supported</div>
                    </div>
                    <div className="bg-primary-foreground/10 backdrop-blur-sm rounded-lg p-4">
                      <div className="text-3xl font-bold">500</div>
                      <div className="text-sm opacity-90">Orphans in School</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
        ...
        {/* Donation Form */}
        <section className="py-20" id="donate-form">
          <div className="container mx-auto px-6 max-w-5xl">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Choose your donation amount, select your preferred payment method, and make an immediate impact.
              </p>
            </div>
